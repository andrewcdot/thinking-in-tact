...
export class Maps implements Contract {
    ...
    static async init(arg: Dictionary<bigint, boolean>, add: Dictionary<bigint, Address>) {
        return await Maps_init(arg, add);
    }
    
    static async fromInit(arg: Dictionary<bigint, boolean>, add: Dictionary<bigint, Address>) {
        const init = await Maps_init(arg, add);
