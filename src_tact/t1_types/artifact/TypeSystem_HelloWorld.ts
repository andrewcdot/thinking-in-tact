...
function ggg() {
    let a: StateInit = {} as StateInit;

    let storeStateInit1 = storeStateInit(a);
    storeStateInit1(new Builder());
}
...
async function HelloWorld_init() {
    const __code = Cell.fromBase64(
        "",
    );
    const __system = Cell.fromBase64(
        "",
    );
